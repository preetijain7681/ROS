...
## Grasping with MoveIt
## Working with robot pick and place task using MoveIt
## Using Dynamixel ROS Servo controllers for Robot hardware interfacing
## Interfacing seven DOF dynamixel based robotic arm to ROS MoveIt
---
 <!--Interfacing I/O boards, sensors, and Actuators to ROS  -->
## Creating a pub and sub for arduino
## Blink Led using Ardunio-ROS
## Accelerometer ADXL using Ardunio-ROS
## Finding distance using ultrasonic distance sensor
## Odometry publisher using Ardunio-ROS
## Interfacing non ardunio boards to ROS
## Working with Odroid
## Interfacing Dynamixel actuators to ROS
---
## Creating plugin for calculator application using pluginlib
## Creating a nodelet
## Creating a basic world plugin
---
## Starting with ROS controllers
## Writing a basic real-time joint controller in ROS
## Using ros_control packages
## Using ROS visualtion tool and its plugin
## Writing a Rviz plugin for teleoperation
---
## Urdf for industrial robot
## MoveIt for industrial robot
## ROS-industrial packages interface
## Working with moveit configuration of ABB robots
## Visualizing ABB robot
## Designing industrial robot client nodes
## Using MoveIt IKFast plugin
## Working with OpenRave
----
